...
import floatingFolderImg from "/src/assets/folder.svg";
import ellipseImg from "/src/assets/ellipse.svg";
import alertImg from "/src/assets/alert.svg";
import convertImg from "/src/assets/convert_closed.svg";
import convertOpenedImg from "/src/assets/convert_opened.svg";
import convertFinalImg from "/src/assets/convert_opened_pamyatka.svg";
...
export function createFloatingFolders() {
  ...
  names.forEach((name) => {
    ...
    folder.innerHTML = `
      <img src="${floatingFolderImg}" alt="folder-header" draggable="false" />
      <h5>${name}</h5>
    `;
    ...
    floating_window.innerHTML = `
        <div class="floating-window__header">
          <div class="floating-window__header_close">
            <img src="${ellipseImg}"  draggable="false" />
            <img src="${ellipseImg}"  draggable="false" />
            <img src="${ellipseImg}"  draggable="false" />
          </div>
          <span>Alert</span>
        ...
        <div class="floating-window__content">
          <img src="${alertImg}"  draggable="false" />
          <p>
